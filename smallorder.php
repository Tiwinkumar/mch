...
function myFunction() {
  ...
  var res = coffee + tea + milk + sweet1 + sweet2 + sweet3 + snack1 + snack2 + snack3;
  var result = res * 25;
...
<div class="wrapper center-block">
  ...
  <tbody>
    <tr>
      ...
      <td>Coffee</td>
      <td>&#8377; 25</td>
      <td id="myinpc"><input type="number" class="form-control" min="0" id="coffee" onchange="myFunction()" value="<?php echo $coffee; ?>" name="qty"></td>
    </tr>
    <tr>
      <th scope="row"><img src="./tea.jpg" height="40px" width="40px"></th>
      <td>Tea</td>
      <td>&#8377; 25</td>
      <td id="myinpt"><input type="number" class="form-control" min="0" id="tea" onchange="myFunction()" value="<?php echo $tea; ?>" name="qty"></td>
    </tr>
    <tr>
      <th scope="row"><img src="./milk.png" height="40px" width="40px"></th>
      <td>Milk</td>
      <td>&#8377; 25</td>
      <td id="myinpm"><input type="number" class="form-control" min="0" id="milk" onchange="myFunction()" value="<?php echo $milk; ?>" name="qty"></td>
    </tr>
  </tbody>
</table>
</div>
  ...
  <tbody>
    <tr>
      ...
      <td>Snack 1</td>
      <td>&#8377; 25</td>
      <td id="myinpsn1" ><input type="number" class="form-control" min="0" id="snack1" onchange="myFunction()" value="<?php echo $snack1; ?>" name="qty"></td>
    </tr>
    <tr>
      <th scope="row"><img src="./blank.jpg" height="40px" width="40px"></th>
      <td>Snack 2</td>
      <td>&#8377; 25</td>
      <td id="myinpsn2" ><input type="number" class="form-control" min="0" id="snack2" onchange="myFunction()" value="<?php echo $snack2; ?>" name="qty"></td>
    </tr>
    <tr>
      <th scope="row"><img src="./blank.jpg" height="40px" width="40px"></th>
      <td>Snack 3</td>
